...
txtFeatsTestDir = '/home/jcleon/Storage/ssd0/FeatsTrain/SoftMaxActivations/AU01_v1_Fold1'
txtFeatsTrainDir = '/home/jcleon/Storage/ssd0/FeatsVal/SoftMaxActivations/AU01_v1_Fold1'
...
trainFeats, trainLabels = balanceSet(trainFeatsUnbalanced, trainLabelsUnbalanced, negProportion, 0.8)
...
model.fit(trainFeats, trainLabels, nb_epoch=150, batch_size=3000, verbose=1, class_weight=classWeights)
